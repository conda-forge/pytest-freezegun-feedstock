...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-freezegun-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8719&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-freezegun-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-freezegun` can be installed with:

```
conda install pytest-freezegun
```

It is possible to list all of the versions of `pytest-freezegun` available on your platform with:
